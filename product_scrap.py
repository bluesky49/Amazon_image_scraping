...
name = []
category = []
with open("Workbook-Worksheet.csv") as csvfile:
...
with open("results.csv","w", newline='') as file:
    ...
    writer.writerow(["Category", "Product Name", "Product Description","External Image URL"])
        ...
        try:
            ...
            for i in g:
                ...
                if "/dp/" in dp.get_attribute("href"):
                    ...
                    print("./result_img/" + product + ".jpg",external_url)
                    local_image_filename = wget.download(external_url,out="./result_img/" + product + ".jpg")
                    data_list = [["SKU", "Product Name", "Product Description","External Image URL","Wordpress Media Library URL"]]
                    writer.writerow([category[0], product, description, external_url])
                    driver.quit()
                    break
                    # except:
                    #     continue
